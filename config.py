...
POSTGRESQL_DB_SHOP = 'demo_bot'
SQLALCHEMY_SHOP_DB_URL = (f'postgresql+asyncpg://{POSTGRESQL_USER}:{POSTGRESQL_PASSWORD}@{POSTGRESQL_HOST}:'
                           f'{POSTGRESQL_PORT}/{POSTGRESQL_DB_SHOP}')
...
POSTGRESQL_DB_SHOP_TEST = 'demo_bot_test'
SQLALCHEMY_SHOP_DB_URL_TEST = (f'postgresql+asyncpg://{POSTGRESQL_USER}:{POSTGRESQL_PASSWORD}@{POSTGRESQL_HOST}:'
                                f'{POSTGRESQL_PORT}/{POSTGRESQL_DB_SHOP_TEST}')
